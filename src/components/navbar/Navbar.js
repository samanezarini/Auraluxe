        ...
        <header className="flex items-center justify-between bg-white shadow-md">
            <div className="w-full">
                <div className="flex justify-between items-center p-6">
                    ...
                    <nav className='hidden md:flex md:flex-row md:items-center gap-10'>
            ...
            {/* Mobile Menu Button */}
            <button
                className="md:hidden text-3xl pr-5 text-gray-700"
            ...
            {isOpen && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 backdrop-blur-sm transition-all duration-500 ease-in-out z-20"></div>
            )}
